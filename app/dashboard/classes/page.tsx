                          ...
                          return (
                            <tr key={idx} style={{ borderBottom: '1px solid #f0eef8', opacity: s.is_cancelled ? 0.5 : 1, background: s.is_cancelled ? '#fafafa' : 'transparent' }}>
                              ...
                              <td style={{ padding: '10px 14px' }}>
                                ...
                                {!s.is_cancelled && pct === 0 && <span style={{ fontSize: 9, padding: '2px 8px', borderRadius: 10, background: '#fdecea', color: '#c0392b', border: '1px solid #f0b8b0', fontWeight: 600 }}>Tomt</span>}
                              </td>
                            </tr>
                          )
                        })}
