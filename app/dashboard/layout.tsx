    ...
    <div style={{ minHeight: '100vh', background: '#f8f7fc', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 20, fontWeight: 700, color: '#fff', letterSpacing: '.12em' }}>
            NRTHRN STRONG
          </div>
        ...
        <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
          ...
          <button
            ...
            style={{ marginLeft: 8, padding: '6px 14px', borderRadius: 24, fontSize: 11, letterSpacing: '.06em', textTransform: 'uppercase', cursor: 'pointer', border: '1px solid rgba(255,255,255,.2)', background: 'transparent', color: 'rgba(255,255,255,.5)', fontFamily: 'Inter, sans-serif' }}
          >
            Log ud
          </button>
        </div>
